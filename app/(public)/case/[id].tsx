...
import Colors, { colorRarityBar, colorRaritySolid } from '@/constants/Colors';
          ...
          <View style={styles.casePreview}>
            ...
            <View style={styles.contentsSection}>
              ...
              <ScrollView
                ...
                nestedScrollEnabled={true}  // ✅ CRUCIAL pour scroll imbriqué
                scrollEnabled={true}
              >
                <View style={styles.skinsGrid}>
                  {caseItem?.skinIds.slice().map((skinId) => {
                    ...
                    return (
                      <View key={skin.id} style={styles.skinPreview}>
                        ...
                        <Image
                          source={
                            skin.rarity === "gold"
                              ? require("@/assets/images/gold.png") // Image locale : direct
                              : { uri: skin.image }                 // Image distante : objet uri
                          }
            ...
            {finalResult && !isRolling && (
              <View style={styles.resultContainer}>
                ...
                >
                  ...
                  <Text style={finalResult.statTrak ? styles.resultWearStatTrak : styles.resultWear}>{finalResult.wear}{finalResult.statTrak && ' | ST'}</Text>
...
const styles = StyleSheet.create({
  ...
  contentsSection: {
    ...
    borderWidth: 1,
    borderColor: Colors.light.border,
    // ❌ PAS de height ici, on le met sur le ScrollView
  },

  // ✅ AJOUTER CES STYLES
  skinsScrollView: {
    maxHeight: 250, // ✅ Hauteur FIXE obligatoire pour que le scroll fonctionne
  },
  ...
  skinsGrid: {
    ...
    justifyContent: 'center',
    gap: 10,
    // ❌ SUPPRIMER height: 150 - laisse le contenu définir sa hauteur
  },
  skinPreview: {
    width: 75,
    height: 60,
